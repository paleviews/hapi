...
// enum out
type DeepQueryResponse_Direction int8
...
// Enum value maps for DeepQueryResponse_Direction.
var (
	name_of_DeepQueryResponse_Direction = map[DeepQueryResponse_Direction]string{
		0: "DIRECTION_UNKNOWN",
		1: "EAST",
		2: "WEST",
		3: "SOUTH",
	...
	value_of_DeepQueryResponse_Direction = map[string]DeepQueryResponse_Direction{
		"DIRECTION_UNKNOWN": 0,
		"EAST":              1,
		"WEST":              2,
		"SOUTH":             3,
...
func (x *DeepQueryResponse_Direction) String() string {
	s, ok := name_of_DeepQueryResponse_Direction[*x]
	if !ok {
...
func (x *DeepQueryResponse_Direction) MarshalJSON() ([]byte, error) {
	return []byte(`"` + x.String() + `"`), nil
}

func (x *DeepQueryResponse_Direction) UnmarshalJSON(data []byte) error {
	var s string
	err := json.Unmarshal(data, &s)
	if err != nil {
		return err
	}
	i, ok := value_of_DeepQueryResponse_Direction[s]
	if !ok {
		return fmt.Errorf("invalid enum %s of type DeepQueryResponse_Direction", s)
	}
	*x = i
	return nil
}
...
type FormDecodeRequest_UUID int8
...
// Enum value maps for FormDecodeRequest_UUID.
var (
	name_of_FormDecodeRequest_UUID = map[FormDecodeRequest_UUID]string{
		0: "UUID_SHORT",
		1: "UUID_MEDIUM",
		2: "UUID_LONG",
	}
	value_of_FormDecodeRequest_UUID = map[string]FormDecodeRequest_UUID{
		"UUID_SHORT":  0,
		"UUID_MEDIUM": 1,
		"UUID_LONG":   2,
	}
...
func (x *FormDecodeRequest_UUID) String() string {
	s, ok := name_of_FormDecodeRequest_UUID[*x]
	if !ok {
		return strconv.Itoa(int(*x))
	}
	return s
...
func (x *FormDecodeRequest_UUID) MarshalJSON() ([]byte, error) {
	return []byte(`"` + x.String() + `"`), nil
}

func (x *FormDecodeRequest_UUID) UnmarshalJSON(data []byte) error {
	var s string
	err := json.Unmarshal(data, &s)
	if err != nil {
		return err
	}
	i, ok := value_of_FormDecodeRequest_UUID[s]
	if !ok {
		return fmt.Errorf("invalid enum %s of type FormDecodeRequest_UUID", s)
	}
	*x = i
	return nil
}
